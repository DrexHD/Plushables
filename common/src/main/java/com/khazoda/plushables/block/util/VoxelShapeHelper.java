...
public final class VoxelShapeHelper {
   ...
   * This should be called once when the block is created, not during gameplay checks.
   */
  ...
  /**
   * Rotates a shape by transforming each box corner and rebuilding the box bounds.
   */
  ...
  /**
   * Gets the front direction for a rotation around the attached block face.
   */
  ...
  /**
   * Converts a front direction into the matching 0-3 rotation value on that attachment face.
   */
  ...
  /**
   * Rotates a direction around the face the plushable is attached to.
   */
  ...
  /**
   * Gets a cached outline shape for the attachment and rotation state.
   */
  ...
  /**
   * Converts a face and rotation into the cached shape/model orientation index.
   */
  ...
  public record Orientation(Direction attachment, Direction front, Direction right) {
    /**
     * Builds the orientation basis used for rotating shapes and baked model quads.
     */
    ...
    /**
     * Transforms a block-space position around the block centre.
     */
    ...
    /**
     * Transforms a direction vector without shifting it around the block centre.
     */
    ...
    /**
     * Transforms a cardinal direction into corresponding orientation.
     */
