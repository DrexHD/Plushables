...
public record InteractionEffectData(SoundEvent soundEvent, float soundVolume, float soundPitch,
                                    ...
                                    float particleYOffset, int cooldownPeriod, int lightLevel) {
  public static final InteractionEffectData DEFAULT = new InteractionEffectData(MainRegistry.PLUSHABLE_GENERIC.get(), 2.0F, 1.0F, null, 0, 0.5, 0, 10, 0);
}